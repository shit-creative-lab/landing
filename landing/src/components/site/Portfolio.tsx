...
const cases: Case[] = [
  {
    ...
    chaos: "Hub inmobiliario con autoridad técnica pero estética de PDF de 2014.",
  ...
  },
  {
    ...
    move: "Hype engineering quirúrgico dentro del ecosistema Stream Fighters: storyline, drops y momentos virales.",
  ...
  },
  {
    ...
    chaos: "Marca arrastrando estigma nocturno y percepción de bajo perfil cultural.",
    move: "Reposicionamiento como ecosistema premium: identidad, ritual de marca y curaduría de experiencias.",
  ...
  },
  {
    ...
    shortImpact: "Nodo central de la escena urbana en Medellín.",
    chaos: "Talento sin red. Escena urbana fragmentada y sin posicionamiento estratégico.",
    move: "Diseño y ejecución de eventos masivos de networking + narrativa de marca para artistas.",
